...
VkResult VK_Renderer::VkInit()
{
	...
	if ( VK_SUCCESS != ( returnResult = A_VkValidateSystem() ) )			return returnResult;
	if ( VK_SUCCESS != ( returnResult = B_VkChoosePhysiccalDevice() ) )		return returnResult;
	if ( VK_SUCCESS != ( returnResult = C_VkInitLogicalDevice() ) )			return returnResult;

	return returnResult;
}


VkResult VK_Renderer::A_VkValidateSystem()
{
...
VkResult VK_Renderer::B_VkChoosePhysiccalDevice()
{
...
VkResult VK_Renderer::C_VkInitLogicalDevice()
{
	VkResult returnResult;
